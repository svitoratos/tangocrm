...
export const metadata: Metadata = generateMetadata({
  ...
  description: 'Choose the perfect Tango CRM plan for your creator business. Starting at $49.99/month. No setup fees, cancel anytime. 14-day satisfaction guarantee. Built for creators, coaches, podcasters, and freelancers.',
  keywords: [
    'creator CRM pricing',
