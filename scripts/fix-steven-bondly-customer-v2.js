...
async function fixStevenBondlyCustomerV2() {
  try {
    ...
    // 4. Instead of transferring subscriptions, we'll:
    //    - Keep all subscriptions where they are
    //    - Update our database to use the primary customer ID
    //    - Ensure future purchases use the primary customer ID
...
// Run the fix
console.log('🚀 Starting duplicate customer fix V2 for stevenvitoratos@getbondlyapp.com...');
console.log('💡 This version analyzes the situation and provides a database update strategy\n');

fixStevenBondlyCustomerV2()
  .then(() => {
    console.log('\n✅ Script completed');
    process.exit(0);
  })
